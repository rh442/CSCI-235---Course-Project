...
*/
  ...
  */
    Ingredient(std::string nam,std::string descript,int qty, int prce,std::vector<Ingredient*> rcp){
        name_=nam;
...
*/
    int getPosOf(const std::string &Iname);
/**
    @param: A const string reference to a ingredient name
    @return: True if the ingredient information is already in the Pantry
*/
    bool contains(const std::string &Iname);
    /**
...
*/
    bool addIngredient(Ingredient* ingred);
    /**
...
*/
    ...
    bool addIngredient(const std::string &nam, const std::string &descript, const int &qty, const int &prce,const std::vector<Ingredient*> &rcp);
    /**
...
*/
    bool canCreate( Ingredient* ingred);
    /**
    @param: A Ingredient pointer
...
*/
    void printIngredient( Ingredient* ingred) const;
    //helper function for ingredientQuery
    void IQ(const std::string &nam);
    /**
    @param: A const string reference to a ingredient name
...
*/
    void ingredientQuery(const std::string &nam);
    /**
...
*/
    ...
    @post: With default filter "NONE": Print out every ingredient in the list.
        ...
        If the ingredient has no recipe, print "Recipe:\nNONE\n\n" after the price.
*/
    void pantryList(const std::string &name="NONE");
